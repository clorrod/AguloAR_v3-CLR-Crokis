...
public class ARActivityTarget extends AppCompatActivity implements Scene.OnUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_r_target);

        //Vista
        arSceneView = findViewById(R.id.arFragmentTarget);
    ...
    private boolean buildDatabase(Config config) {
        ...
        augmentedImageDatabase.addImage("prueba",bitmap);
    ...
    public void onUpdate(FrameTime frameTime) {
        ...
        for(AugmentedImage imagen : updateAugmentedImage){
            if(imagen.getTrackingState() == TrackingState.TRACKING){
                if(imagen.getName().equals("prueba")){
                    myARNode myARNode = new myARNode(this,"https://github.com/Harichachi/Agulo_AR_modelos_Publico/blob/main/shishkebab.glb?raw=true");
